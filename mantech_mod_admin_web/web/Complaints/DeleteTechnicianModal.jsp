<%-- 
    Document   : DeletedTechnicianModal
    Created on : Nov 11, 2012, 5:52:18 PM
    Author     : NGUYEN
--%>
...
<html>
    ...
    <body>
                ...
                $("#dialog-confirm").dialog({
                    ...
                    buttons:{
                        "Delete this item": function(){
                            var url = "../DeleteTechnicianServlet?id=" + id;
        ...
        <div id="dialog-confirm" title="Remove the technician?">
