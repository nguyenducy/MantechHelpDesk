...
public class TechnicianJpaController {
    ...
    public void create(Technician technician) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findTechnician(technician.getId()) != null) {
                throw new PreexistingEntityException("Technician " + technician + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
