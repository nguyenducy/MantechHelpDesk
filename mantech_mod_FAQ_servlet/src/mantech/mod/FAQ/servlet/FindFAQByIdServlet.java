 ...
 * @author hoangvu
 */
@WebServlet(name="FindFAQByIdServlet", urlPatterns="/findFAQById")
public class FindFAQByIdServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Faq faq = faqBizz.findFAQById(id);

        if (faq != null) {
            session.setAttribute("findFAQById", faq);
        } else {
            session.setAttribute("findFAQById", "fail");
        }
    }
